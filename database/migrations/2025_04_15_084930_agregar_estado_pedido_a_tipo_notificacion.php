...
class AgregarEstadoPedidoATipoNotificacion extends Migration
{
    /**
     * Run the migration.
     */
        ...
        if (DB::connection()->getDriverName() === 'mysql') {
            ...
            if (isset($columnInfo[0])) {
                ...
                if (isset($matches[1])) {
                    ...
                    // Verificar si el valor 'estado_pedido' ya existe
                    if (!in_array('estado_pedido', $enumValues)) {
                        // Añadir el nuevo valor
                        $enumValues[] = 'estado_pedido';
        ...
        if (DB::connection()->getDriverName() === 'mysql') {
            ...
            if (isset($columnInfo[0])) {
                ...
                if (isset($matches[1])) {
                    ...
                    // Eliminar 'estado_pedido' del array
                    $enumValues = array_filter($enumValues, function ($value) {
                        return $value !== 'estado_pedido';
                    });
