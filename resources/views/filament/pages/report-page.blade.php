<x-filament::page>
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <x-filament::section>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        const ctx = document.getElementById('ventasPorPeriodoChart').getContext('2d');
            ...
            <x-filament::section>
                <x-slot name="heading">Ventas por Categoría</x-slot>
                ...
                @php
                    $ventasPorCategoria = $this->getVentasPorCategorias();
                    $categorias = $ventasPorCategoria->pluck('nombre')->toJson();
                    $totalesCategoria = $ventasPorCategoria->pluck('total_vendido')->toJson();
                @endphp
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                        @foreach($this->getTopProductos() as $producto)
                            <tr>
        ...
        <x-filament::section>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                        @foreach($this->getDesempenoRepartidores() as $repartidor)
                            <tr>
