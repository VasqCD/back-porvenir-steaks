    ...
    <section id="menu" class="section-padding bg-white dark:bg-secondary-950">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="card group">
                    <div class="relative overflow-hidden">
                        <img src="https://www.innova-alimentos.mx/img/recetas/83-94caca43.jpg" alt="New York Steak" class="h-64 w-full object-cover transform group-hover:scale-105 transition-transform duration-300">
            ...
            <div class="text-center mt-12">
                <a href="#app" class="btn-primary inline-block">
                    Ver todo el menú
                </a>
            </div>
        </div>
