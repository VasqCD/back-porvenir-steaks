...
class PedidosRelationManager extends RelationManager
{
    ...
    protected static ?string $title = 'Pedidos realizados a esta dirección';
    
    protected static ?string $inverseRelationship = 'ubicacion';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                // Normalmente no permitimos crear pedidos desde aquí
            ])
            ->actions([
                ViewAction::make()
