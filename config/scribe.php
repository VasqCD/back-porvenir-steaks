...
return [
    ...
    'title' => 'Porvenir Steaks API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API REST para el sistema de pedidos de El Porvenir Steaks, incluyendo gestión de usuarios, productos, categorías, pedidos, repartidores y más.',

    // The base URL displayed in the docs.
    // If you're using `laravel` type, you can set this to a dynamic string, like '{{ config("app.tenant_url") }}' to get a dynamic base URL.
    'base_url' => 'https://porvenirsteaks.icu/',
    ...
    'auth' => [
        ...
        'placeholder' => '{SCRIBE_AUTH_KEY}',

        // Any extra authentication-related info for your users. Markdown and HTML are supported.
        'extra_info' => 'Puedes obtener tu token realizando una petición POST a `/api/login` con tus credenciales de usuario. También puedes registrarte en `/api/register`.',
    ],
